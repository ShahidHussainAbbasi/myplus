 ...
 * {@code com.web.dto.business.InstallmentPlanDTO} is the same shape. The monolith's {@code SellController}
 * binds {@code @RequestBody CustomerHistoryDTO} and then <b>re-serialises it</b> to business-service, so a
 * field that exists only here is <b>silently discarded in transit</b>: the sale succeeds, the invoice is
 * correct, and the plan simply never exists. Nothing errors and no test fails.
 *
