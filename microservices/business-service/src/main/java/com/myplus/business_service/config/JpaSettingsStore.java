...
import com.myplus.business_service.entity.OrgSetting;
import com.myplus.business_service.repository.OrgSettingRepository;
...
/**
 * business-service's {@link SettingsStore} — the SPI impl backing the shared common-settings engine onto this
 * service's own {@code org_setting} table. Its presence is what activates the shared SettingsService/Controller
 * (the auto-config is @ConditionalOnBean(SettingsStore.class)).
 */
@Component
