...
import com.myplus.business_service.repository.ItemTypeRepo;
...
public class ItemTypeService implements IItemTypeService {
	...
	@Override
	public void deleteAllInBatch(Iterable<ItemType> entities) {
		// TODO Auto-generated method stub
	...
	@Override
	public <S extends ItemType> List<S> saveAllAndFlush(Iterable<S> entities) {
		// TODO Auto-generated method stub
	...
	@Override
	public <S extends ItemType, R> R findBy(Example<S> example, Function<FetchableFluentQuery<S>, R> queryFunction) {
		// TODO Auto-generated method stub
