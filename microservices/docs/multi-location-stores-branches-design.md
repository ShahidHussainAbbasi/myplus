...
- [ ] Attendance / fees / guardians / staff have **no `school_id`** of their own — they inherit the branch through the student or grade they hang off, so their direct list endpoints are still org-wide. Same staging as business's P2c.
