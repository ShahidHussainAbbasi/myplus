...
import com.myplus.agriculture.entity.OrgSetting;
import com.myplus.agriculture.repository.OrgSettingRepository;
...
/**
 * agriculture-service's {@link SettingsStore} — the SPI impl backing the shared common-settings engine onto this
 * service's own {@code org_setting} table (Flyway V4). Its presence activates the shared
