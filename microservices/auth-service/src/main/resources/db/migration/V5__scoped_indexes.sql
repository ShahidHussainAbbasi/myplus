...
SET @ddl := IF((SELECT COUNT(*) FROM information_schema.STATISTICS
                WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='memberships' AND INDEX_NAME='idx_memberships_org_user')=0,
    'CREATE INDEX idx_memberships_org_user ON memberships (organization_id, user_id)', 'DO 0');
