 ...
 * common-settings engine onto welfare-service's own {@code org_setting} table. Holds only the values an owner
 * has changed from the code-defined catalog default ({@link com.myplus.welfare.config.WelfareSettingsCatalog}).
 */
@Entity
