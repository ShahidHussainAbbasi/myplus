...
/**
 * education-service's {@link SettingsStore} — the SPI impl backing the shared common-settings engine onto this
 * service's own {@code org_setting} table (Flyway V5). Its presence is what activates the shared
