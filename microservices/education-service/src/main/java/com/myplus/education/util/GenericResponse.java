...
/**
 * Legacy response envelope expected by the monolith front-end JS ({status, message, object,
 * collection, error}). Mirrors business-service so the flat education endpoints return the same
 * shape the existing education pages/JS consume.
 */
