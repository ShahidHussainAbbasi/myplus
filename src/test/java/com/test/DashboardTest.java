...
import com.service.education.DashboardService;
...
//, ServiceConfig.class, TestIntegrationConfig.class
@SpringBootTest(classes = { PersistenceJPAConfig.class,ServiceConfig.class })
...
//    	DashboardDTO dto = DashboardDTO.builder().lastMonth(appUtil.getLocalDateStr(appUtil.dateOfLastMonth())).build();
    	IDashboardService service = new DashboardService();
    	Object obj = service.getDashboardData(appUtil.getLocalDateStr(appUtil.dateOfLastMonth()),requestUtil.getCurrentUser().getId());
